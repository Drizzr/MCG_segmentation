...
Reference: Laguna P, Mark RG, Goldberger AL, Moody GB. A Database for Evaluation of Algorithms for Measurement of QT and Other Waveform Intervals in the ECG. Computers in Cardiology 24:673-676 (1997). Link to PhysioNet
...
See section 6.2. Training Script (train.py).
...
See section 7. Evaluation (evaluate.py).
...
Reference: Peimankar, A., & Puthusserypady, S. (2020). DENS-ECG: A deep learning approach for ECG signal delineation. arXiv. https://arxiv.org/abs/2005.08689

<p align="center">
<b>Fig 9.3.1: DENS_ECG_segmenter Training Metrics</b><br>
<img src="https://github.com/user-attachments/assets/c5903618-57c9-4852-8b3b-85d7bf6071ed" alt="DENS_ECG_segmenter Training Metrics" width="600">
</p>
...
<b>Fig 9.3.2: DENS_ECG_segmenter Confusion Matrix (No Noise)</b><br>
<img src="https://github.com/user-attachments/assets/cf78d687-0ca5-4542-b9a6-5efa79c8368e" alt="DENS_ECG_segmenter Confusion Matrix (No Noise)" width="400">
</td>
<td align="center" valign="top">
<b>Fig 9.3.3: DENS_ECG_segmenter Sample Plot (No Noise)</b><br>
...
<tr>
<td align="center" valign="top">
<b>Fig 9.3.4: DENS_ECG_segmenter Confusion Matrix (With Noise)</b><br>
...
<td align="center" valign="top">
<b>Fig 9.3.5: DENS_ECG_segmenter Sample Plot (With Noise)</b><br>
<img src="https://github.com/user-attachments/assets/b266f523-d25f-4722-9235-4cce306bba11" alt="DENS_ECG_segmenter Sample Plot (With Noise)" width="400">
</td>
</tr>
</table>
9.4. ECGSegmenter (Small) Results
<p align="center">
<b>Fig 9.4.1: ECGSegmenter (Small) Training Metrics</b><br>
<img src="https://github.com/user-attachments/assets/e8a7e14f-9470-4e15-8326-99dc66dbb4c6" alt="ECGSegmenter (Small) Training Metrics" width="600">
</p>
Evaluation on Data without Additional DataLoader Noise (validation set):
...
<tr>
<td align="center" valign="top">
<b>Fig 9.4.2: ECGSegmenter (Small) Confusion Matrix (No Noise)</b><br>
<img src="https://github.com/user-attachments/assets/3b78e756-3594-4089-b019-fcf98d1da11a" alt="ECGSegmenter (Small) Confusion Matrix (No Noise)" width="400">
</td>
<td align="center" valign="top">
<b>Fig 9.4.3: ECGSegmenter (Small) Sample Plot (No Noise)</b><br>
<img src="https://github.com/user-attachments/assets/d4772d72-28a3-45db-9757-56aec2a460cd" alt="ECGSegmenter (Small) Sample Plot (No Noise)" width="400">
</td>
</tr>
</table>
Evaluation on Data with Additional DataLoader Noise (validation set, augmentation_prob=1.0):
...
<tr>
<td align="center" valign="top">
<b>Fig 9.4.4: ECGSegmenter (Small) Confusion Matrix (With Noise)</b><br>
<img src="https://github.com/user-attachments/assets/3c0b60c0-4049-4d66-9788-c2ca67a182cc" alt="ECGSegmenter (Small) Confusion Matrix (With Noise)" width="400">
</td>
<td align="center" valign="top">
<b>Fig 9.4.5: ECGSegmenter (Small) Sample Plot (With Noise)</b><br>
<img src="https://github.com/user-attachments/assets/28eaf65a-300a-4629-956c-ae8f59b99d4e" alt="ECGSegmenter (Small) Sample Plot (With Noise)" width="400">
</td>
</tr>
</table>
9.5. ECGSegmenter (XL) Results
<p align="center">
<b>Fig 9.5.1: ECGSegmenter (XL) Training Metrics</b><br>
<img src="https://github.com/user-attachments/assets/664a9405-d3e2-43dd-8066-12fa1758e069" alt="ECGSegmenter (XL) Training Metrics" width="600">
</p>
Evaluation on Data without Additional DataLoader Noise (validation set):
...
<tr>
<td align="center" valign="top">
<b>Fig 9.5.2: ECGSegmenter (XL) Confusion Matrix (No Noise)</b><br>
<img src="https://github.com/user-attachments/assets/9e906eaa-6594-4920-b7e4-15f88b8a17fa" alt="ECGSegmenter (XL) Confusion Matrix (No Noise)" width="400">
</td>
<td align="center" valign="top">
<b>Fig 9.5.3: ECGSegmenter (XL) Sample Plot (No Noise)</b><br>
<img src="https://github.com/user-attachments/assets/55b66bc5-b82b-449b-bbd9-c297f481e33a" alt="ECGSegmenter (XL) Sample Plot (No Noise)" width="400">
</td>
</tr>
</table>
Evaluation on Data with Additional DataLoader Noise (validation set, augmentation_prob=1.0):
...
<tr>
<td align="center" valign="top">
<b>Fig 9.5.4: ECGSegmenter (XL) Confusion Matrix (With Noise)</b><br>
<img src="https://github.com/user-attachments/assets/415ea4eb-0f49-467b-bb04-167c2b2b1ad2" alt="ECGSegmenter (XL) Confusion Matrix (With Noise)" width="400">
</td>
<td align="center" valign="top">
<b>Fig 9.5.5: ECGSegmenter (XL) Sample Plot (With Noise)</b><br>
<img src="https://github.com/user-attachments/assets/43be637f-2dd9-404d-8b33-fd3563e5fcd5" alt="ECGSegmenter (XL) Sample Plot (With Noise)" width="400">
</td>
</tr>
</table>
